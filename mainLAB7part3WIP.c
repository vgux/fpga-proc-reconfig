...
int main(void)
{
	...
	line_t line_history[BUFFER_NUMBER][NODE_NUMBER];
	...
	*BACK_BUFFER_ADDRESS = BACK_PIXELMAP_BASE_ADDRESS;
	...
	for(node_index = 0; node_index < NODE_NUMBER; node_index++)
	{
		...
		line_history[0][node_index].x0 = node_array[node_index].xCoord;
		line_history[0][node_index].x1 = node_array[node_index].xCoord;
		line_history[0][node_index].y0 = node_array[node_index].yCoord;
		line_history[0][node_index].y1 = node_array[node_index].yCoord;


		line_history[1][node_index].x0 = node_array[node_index].xCoord;
		line_history[1][node_index].x1 = node_array[node_index].xCoord;
		line_history[1][node_index].y0 = node_array[node_index].yCoord;
		line_history[1][node_index].y1 = node_array[node_index].yCoord;
	}
	...
	while(1)
	{
		...
		for(node_index = 0; node_index < NODE_NUMBER; node_index++)
		{
			drawLineColor(line_history[bufSelect][node_index].x0 = node_array[node_index].xCoord,
						line_history[bufSelect][node_index].x1 = node_array[node_index].xCoord,
						line_history[bufSelect][node_index].y0 = node_array[node_index].yCoord,
						line_history[bufSelect][node_index].y1 = node_array[node_index].yCoord, 
					  	BLACK_COLOR);
		}
		...
		line_history[bufSelect][node_index].x0 = node_array[node_index].xCoord;
		line_history[bufSelect][node_index].x1 = node_array[(node_index + 1) % NODE_NUMBER].xCoord;
		line_history[bufSelect][node_index].y0 = node_array[node_index].yCoord;
		line_history[bufSelect][node_index].y1 = node_array[(node_index + 1) % NODE_NUMBER].yCoord;
